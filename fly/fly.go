...
func CreateFullCHMachine(ctx context.Context, name, region, keeperHost, keeperPort, remoteReplicas, shard, cluster, replica, cpuKind string, cpus, memoryMB int64) (*FlyMachine, error) {
